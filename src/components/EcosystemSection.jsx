...
const insights = [
  { value: '↑', label: 'Conocimiento acumulado', desc: 'Cada consulta enriquece la base para toda la red.' },
  { value: '∞', label: 'Aprendizaje continuo',   desc: 'El sistema mejora con cada agricultor que se suma.' },
...
const actors = [
  ...
  { icon: Users,         bg: 'bg-purple-100',      color: 'text-purple-700',     label: 'UC / Academia',     sub: 'Investigan y certifican' },
]
