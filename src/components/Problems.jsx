...
function Card({ p, i }) {
  ...
  return (
    <div
      ref={ref}
      className={`card-hover bg-white border border-gray-100 rounded-2xl p-5 flex gap-4 items-center transition-all duration-500 ${
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="bg-agro-green-700 rounded-2xl p-5 flex flex-col justify-between">
            <p className="font-semibold text-white text-sm leading-snug mb-3">
              Respuesta integrada a cada problemática del territorio.
            </p>
